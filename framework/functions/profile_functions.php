...
if( !function_exists('houzez_ajax_update_profile') ):
    ...
    function houzez_ajax_update_profile(){
        ...
        if ( !empty( $_POST['id_number'] ) ) {
            ...
            update_user_meta( $userID, 'fave_author_id_number', $id_number );
        } else {
            delete_user_meta( $userID, 'fave_author_id_number' );
        }
...
if ( ! function_exists( 'houzez_author_info' ) ) :
    ...
    function houzez_author_info( $contactmethods ) {
        ...
        $contactmethods['fave_author_id_number']      = esc_html__( 'Id Number', 'houzez' );
...
if( !function_exists('houzez_profile_update') ) {
    function houzez_profile_update($user_id, $old_user_data)
    {
        ...
        if ( in_array('houzez_agent', (array)$roles ) || in_array('houzez_agency', (array)$roles ) ) {
            ...
            $fave_author_id_number = get_the_author_meta('fave_author_id_number', $user_id);
            ...
            if ( in_array('houzez_agent', (array)$roles ) ) {
                if (!empty($user_agent_id)) {
                    ...
                    update_post_meta($user_agent_id, 'fave_author_id_number', $fave_author_tax_no);
...
if (!function_exists('houzez_custom_user_profile_fields')) {
    function houzez_custom_user_profile_fields($user)
    {
        if (in_array('houzez_agent', (array)$user->roles)) {
            ...
            $information_title = esc_html__('Profile Info new', 'houzez');
            $title = esc_html__('Title/Position', 'houzez');
        } ?>
        ...
        <table class="form-table">
            ...
            <tbody>
                ...
                <!-- add id number -->
                <tr class="user-fave_author_id_number-wrap">
                    <th><label for="fave_author_id_number"><?php echo esc_html__('Id Number', 'houzez'); ?></label></th>
                    <td><input type="text" name="fave_author_id_number" id="fave_author_id_number" value="<?php echo esc_attr(get_the_author_meta('fave_author_id_number', $user->ID)); ?>" class="regular-text"></td>
                </tr>
...
add_action('show_user_profile', 'houzez_custom_user_profile_fields', 20);
add_action('edit_user_profile', 'houzez_custom_user_profile_fields', 20);
...
if( !function_exists('houzez_update_extra_profile_fields') ) {
    function houzez_update_extra_profile_fields($user_id)
    {
        ...
        /*
         * Agent and agency Info fave_author_id_number
        --------------------------------------------------------------------------------*/
        ...
        update_user_meta($user_id, 'fave_author_id_number', $_POST['fave_author_id_number']);
