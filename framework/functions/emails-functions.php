...
if (!function_exists('houzez_email_type')) {
    function houzez_email_type( $email, $email_type, $args ) {
        ...
        if( wp_doing_cron() ) {
            $value_subject = get_option('houzez_subject_' . $email_type);
            $value_message = get_option('houzez_' . $email_type);
        }
...
if( !function_exists('houzez_send_emails_with_reply') ):
    function houzez_send_emails_with_reply( $user_email, $subject, $message, $sender_name, $sender_email, $cc_email, $bcc_email ){
        ...
        if( wp_doing_cron() ) {
            ...
            $enable_html_emails  = get_option('houzez_enable_html_emails');
            $enable_email_header = get_option('houzez_enable_email_header');
            $enable_email_footer = get_option('houzez_enable_email_footer');

            $email_footer_content = get_option('houzez_email_footer_content');
            ...
            $social_1_icon = get_option('houzez_social_1_icon');
            $social_1_link = get_option('houzez_social_1_link');
            $social_2_icon = get_option('houzez_social_2_icon');
            $social_2_link = get_option('houzez_social_2_link');
            $social_3_icon = get_option('houzez_social_3_icon');
            $social_3_link = get_option('houzez_social_3_link');
            $social_4_icon = get_option('houzez_social_4_icon');
            $social_4_link = get_option('houzez_social_4_link');
        }
