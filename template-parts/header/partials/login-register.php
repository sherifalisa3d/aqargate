			...
			if( ( houzez_option('header_login') || houzez_option('header_register') ) && !is_user_logged_in() && !houzez_is_login_page() ) { 
				...
				if( $login_resgiter_type == 'as_text' ) { ?>
					...
					<li class="favorite-link">
						<a href="<?php echo esc_url($favorite_template); ?>"><?php echo houzez_option('dsh_favorite', 'Favorites'); ?>  <span class="btn-bubble frvt-count">0</span></a>
					</li>
				...
				<?php 
					...
					<li class="nav-item login-link">
						...
						<ul class="dropdown-menu">
							<li class="nav-item">
								<a class="dropdown-item" href="<?php echo esc_url($favorite_template); ?>"><i class="houzez-icon icon-love-it mr-2"></i> <?php echo houzez_option('dsh_favorite', 'Favorites'); ?> <span class="btn-bubble frvt-count">0</span></a>
							</li>
						</ul>
					</li>
				<?php } 
