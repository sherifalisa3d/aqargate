...
<div class="item-listing-wrap hz-item-gallery-js item-listing-wrap-v4 card" data-hz-id="hz-<?php esc_attr_e($post->ID); ?>" <?php houzez_property_gallery('houzez-item-image-4'); ?>>
