...
<div class="dashboard-content-block">
    <div class="row">
        <div class="col-md-3 col-sm-12">
            <a href="<?php echo esc_url($packages_page_link); ?>" target="_blank" class="btn btn-warning mb-4 text-center w-100"> شراء الباقة </a>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="id_number" value="<?php echo esc_attr( $id_number );?>" class="form-control" placeholder="<?php esc_html_e('يرجي ادخال رقم الهوية','houzez');?>">
                    </div>
                </div>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
